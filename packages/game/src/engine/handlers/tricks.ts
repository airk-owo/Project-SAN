...
import type { Card, CurrentAction, GameState, TargetCardSelection } from '../types.js';
import { characterName, findHandCard, flashTable, getAlivePlayers, getAlivePlayersInSeatOrder, getPlayerById, grantDraws, logAction, moveToDiscard, numberParam, reshuffleDiscardIntoDrawPile, resolveHiddenHandCard, synchronizeGameState, toCardInstance, validateHiddenHandIndex, type RuntimeEquipmentSlot } from '../state.js';
import { canPlayerAct, createTargetedCardAction, resolveTargetedCardAction } from '../actions.js';
import { attackDodgesRequired, cardActsAs, hasCharacterSkill } from './character-skills.js';
