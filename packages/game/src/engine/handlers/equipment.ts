...
import { characterName, equipmentSlotForCard, findHandCard, getPlayerById, grantDraws, logAction, moveToDiscard, numberParam, reshuffleDiscardIntoDrawPile, synchronizeGameState, toCardInstance, type RuntimeEquipmentSlot } from '../state.js';
import { canPlayerAct, createTargetedCardAction, resolveTargetedCardAction } from '../actions.js';
import { assertForcedAttackTarget, attackDamageBonus, attackDodgesRequired, hasCharacterSkill, isImmuneToAttack } from './character-skills.js';
import { applyDamage, canTargetWithAttack, openAttackDodgeWindow, playAttack, resolveCurrentAction } from './combat.js';
...
export const areOppositeGenders=(a:Player,b:Player)=>Boolean(a.character?.gender&&b.character?.gender&&a.character.gender!==b.character.gender);
