...
type Card={id:string;name:string;type:string;cardType:string;suit:string;number:string;description:string|null;effect:string|null;equipmentSlot:string|null;image?:string|null};
